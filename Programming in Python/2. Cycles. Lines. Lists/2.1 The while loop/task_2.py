...
a и b, каждое число вводится на отдельной строке) и выводить наименьшее число d, которое делится на оба этих числа без остатка."""

computer_scientists = int(input())
biologists = int(input())
smallest_divisor = computer_scientists

if biologists > computer_scientists:
    smallest_divisor = biologists
while smallest_divisor % computer_scientists != smallest_divisor % biologists:
