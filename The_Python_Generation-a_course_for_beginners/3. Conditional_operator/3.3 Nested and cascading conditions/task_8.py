...
if pocket_number == 0:
    print('зеленый')
elif ((0 < pocket_number <= 10) and pocket_number % 2 == 0) or ((10 < pocket_number <= 18) and pocket_number % 2 != 0) or ((18 < pocket_number <= 28) and pocket_number % 2 == 0) or ((28 < pocket_number <= 36) and pocket_number % 2 != 0):
    print('черный')
elif ((0 < pocket_number <= 10) and pocket_number % 2 != 0) or ((10 < pocket_number <= 18) and pocket_number % 2 == 0) or ((18 < pocket_number <= 28) and pocket_number % 2 != 0) or ((28 < pocket_number <= 36) and pocket_number % 2 == 0):
    print('красный')
else:
